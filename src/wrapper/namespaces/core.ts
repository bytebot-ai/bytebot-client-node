...
export class BytebotCore {
    ...
    public async act({ prompt, page, options }: BytebotCore.CoreActOptions): Promise<Bytebot.ActResponseActionsItem[]> {
        const { url, html } = page;
    ...
    public async extract({
        ...
        page,
        options,
    }: BytebotCore.CoreExtractOptions): Promise<[Bytebot.ExtractResponseAction] | []> {
        const { url, html } = page;
        this.logger.info("Generating actions");
